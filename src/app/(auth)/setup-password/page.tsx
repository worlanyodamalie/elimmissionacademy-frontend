...
function SetupPasswordForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const fallback =
        apiErr.status === 401
          ? "This activation link is no longer valid. It may have already been used or expired. Ask your administrator to resend it."
          : "Could not set up your password.";
    ...
    return (
      <Card className="p-8">
        ...
        <p className="mx-auto mt-2 max-w-sm text-center text-sm text-zinc-500 dark:text-zinc-400">
          Your account is ready. Save your school code — you&apos;ll need it
    ...
    return (
      <Card className="p-8">
        <Alert variant="error" title="This link is invalid">
          The activation link is missing required information. Open the link
          from your welcome email again, or ask your administrator to resend
          it.
        </Alert>
        <Link
          href={ROUTES.login}
